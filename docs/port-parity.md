...
- `tests/run.sh` passed: 26 tests.
- `python3 -m pytest -q` passed: 13 tests.
- `python3 -m pytest -q tests/test_package.py` passed: 5 tests.
- `python3 -m pytest -q tests/test_telegram.py` passed: 26 tests.
