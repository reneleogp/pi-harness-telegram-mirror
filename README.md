...
The reload command uses that same connected socket and ownership boundary, invokes Pi's native `/reload` action, and never starts or restarts Pi or the Telegram service.
